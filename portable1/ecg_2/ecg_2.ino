...
#define led 13
#define WIFISSID "IEP" // Enter WifiSSID here
#define PASSWORD "12345678" // Enter password here
#define TOKEN "BBUS-muEiyyexlPM3NcPGfLbFtvYm7Q4d5c" // Ubidots' TOKEN
#define MQTT_CLIENT_NAME "ECG_34356789" // MQTT client Name
// * Define Constants
#define VARIABLE_LABEL "ecg_data" // ubidots variable label
#define DEVICE_LABEL "ecg_mon"
 // ubidots device label


#define SENSORPIN 39 // Set the A0 as SENSORPIN
